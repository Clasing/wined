...
export default function SignUpPage(): JSX.Element {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center p-8">
      ...
      >
        <h1 className="text-2xl font-bold text-wined-700">Wined</h1>
        ...
        <button
          disabled={pending}
          type="submit"
          className="w-full rounded-md bg-wined-500 px-4 py-2 text-white hover:bg-wined-700 disabled:opacity-50"
        >
          {pending ? 'Creando…' : 'Crear cuenta'}
        </button>
        <p className="text-xs text-gray-500 text-center">
          ¿Ya tienes?{' '}
          <Link href="/sign-in" className="text-wined-700 underline">
            Entrar
          </Link>
        </p>
      </form>
